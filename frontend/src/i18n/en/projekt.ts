...
export const projekt: Record<string, string> = {
  "Betydelse och förbehåll": "Meaning and qualifications",
  "Givare": "Sensor",
  "Instrument": "Instrument",
  "Antal rör enligt referenskonventionen": "Pipe count according to the reference convention",
  "Kräver stöd i ritningens redovisning.": "Requires evidence in the drawing.",
  "Regler, symboler och källdokument": "Rules, symbols and source documents",
  "Fullständiga källtexter från de två kodbaserna. Referensregler är inte automatiskt aktiva analysregler.": "Complete source texts from the two codebases. Reference rules are not automatically active analysis rules.",
  "Sök i regler och källtexter…": "Search rules and source texts\u2026",
  "Historisk version": "Historical version",

  "Obegränsad lokal analys. Du kan läsa och läsa om ritningar utan credits.": "Unlimited local analysis. Read and reread drawings without credits.",
  "Lokal installation": "Local installation",
  ...
  "Välj ritning": "Select drawing",
  "Kontrollera att samma ritning inte väljs i flera revisioner.": "Check that you have not selected multiple revisions of the same drawing.",
  ...
  "Dimensionsregler": "Dimension rules",
  "Modellbedömning": "Model assessment",
  "Jämför båda": "Compare both",
  "Analysläge": "Analysis mode",
  "Den här äldre analysen saknar källmotorernas resultat. Starta en ny analys för att använda dem.": "This older analysis has no source engine results. Start a new analysis to use them.",
  "Körd": "Completed",
  "Inte vald": "Not selected",
  "Anslutning saknas": "Connection missing",
  "Misslyckad": "Failed",
  "Utan tilldelning": "Unassigned",
  "PipeStudios analyslägen": "PipeStudio analysis modes",
  "Mängderna nedan använder": "Quantities below use",
  "Jämförelsen kunde inte slutföras. Ingen överensstämmelse mellan motorerna är verifierad.": "Comparison could not be completed. Agreement between the engines has not been verified.",
  "Sträckor med olika tilldelning": "Stretches with different assignments",
  "Svar från de två lägena slås inte ihop.": "Results from the two modes are not merged.",
  "Granska skillnader på ritningen": "Review differences on the drawing",
  "Starta med valt läge": "Start selected mode",
  "Regelkälla: PipeStudio och Swedish VVS. Geometrin läses av VVS5. Stilprofil och systeminträden är ännu inte kopplade till källmotorerna; resultatet behöver granskas.": "Rule source: PipeStudio and Swedish VVS. VVS5 reads geometry. Style profiles and system entries are not yet connected to the source engines; results require review.",
  "Fullständiga källtexter från de två kodbaserna. Analysens valda läge visar vilken tilldelningsmotor som kördes. Importstatus är inte ett testresultat.": "Complete source texts from both codebases. The selected analysis mode shows which assignment engine ran. Import status is not a test result.",
  "Ritningsstil": "Drawing style",
  "Identifiera automatiskt": "Identify automatically",
  "Inte identifierad": "Not identified",
  "Regelkälla: PipeStudio och Swedish VVS. Vald stil följer modellens bedömning. Geometrin läses av VVS5; systeminträden är ännu inte fullständigt identifierade. Resultatet behöver granskas.": "Rule source: PipeStudio and Swedish VVS. The selected style is supplied to the model. VVS5 reads geometry; system entries are not yet fully identified. Results require review.",
};
